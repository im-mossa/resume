  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div>
        ...
        <input {...register('fullName')} className="w-full border rounded px-3 py-2" id="f-name" />
      ...
      <div>
        ...
        <input {...register('email')} className="w-full border rounded px-3 py-2" id="email" />
      ...
      <div>
        ...
        <input {...register('phone')} className="w-full border rounded px-3 py-2" id="tel" />
